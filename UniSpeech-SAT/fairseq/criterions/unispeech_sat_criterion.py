...
@dataclass
class UniSpeechSATCriterionConfig(FairseqDataclass):
...
@register_criterion("unispeech_sat", dataclass=UniSpeechSATCriterionConfig)
class UniSpeechSATCriterion(FairseqCriterion):
