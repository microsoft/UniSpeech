...
from fairseq.tasks.unispeech_sat_pretraining import (
    UniSpeechSATPretrainingConfig,
...
class UniSpeechSATModel(BaseFairseqModel):
    def __init__(
        ...
        task_cfg: UniSpeechSATPretrainingConfig,
    ...
    @classmethod
    def build_model(cls, cfg: UniSpeechSATConfig, task: UniSpeechSATPretrainingTask):
    ...
    def forward(
        ...
        result = {"x": x, "padding_mask": padding_mask, "features": features}
