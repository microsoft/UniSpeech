...
class UniSpeechSATDataset(FairseqDataset):
    def __init__(
        self,
        manifest_path: str,
        sample_rate: float,
    ...
    def batch_by_size(self, indices, max_tokens=None, max_sentences=None, required_batch_size_multiple=1):
        ...
        if isinstance(indices[0], list):
            ...
            for indice in indices:
                batch = super(UniSpeechSATDataset, self).batch_by_size(indice, max_tokens, max_sentences, required_batch_size_multiple)
                batch_list.append(batch)
            return batch_list
        else:
            return super(UniSpeechSATDataset, self).batch_by_size(indices, max_tokens, max_sentences, required_batch_size_multiple)
