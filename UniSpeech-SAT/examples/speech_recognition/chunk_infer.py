...
def load_models_and_criterions(
    filenames, test_chunk_files,
    test_chunk_paths, test_trans_paths,
    test_subcorpus, arg_overrides=None, 
    task=None, model_state=None
):
    models = []
    criterions = []
    ...
    for filename in filenames:
        ...
        if task is None:
            cfg.task.test_chunk_files = test_chunk_files
            cfg.task.test_trans_paths = test_trans_paths
            cfg.task.test_chunk_paths = test_chunk_paths
            cfg.task.test_subcorpus = test_subcorpus
        ...
        if "criterion" in state and state['criterion'] is not None:
...
def main(args, task=None, model_state=None):
    ...
    if args.load_emissions:
        ...
        models, criterions, task = load_models_and_criterions(
            args.path,
            args.test_chunk_files,
            args.test_chunk_paths,
            args.test_trans_paths,
            args.test_subcorpus,
